...
const calendarEvents = [
    ...
    { start: '2026-09-18', end: '2026-09-20', title: '7 поток Базовые Остеопатические Технологии, часть 2', target: 'osteocorrection.html', program: 'Специалист Остеокоррекции', shortTitle: 'Базовые ОТ, 2 часть' },
    ...
    { start: '2026-12-16', end: '2026-12-17', title: 'Диссекция «Жир и фасции — скрытая механика боли и старения»', target: 'osteocorrection.html', program: 'Специалист Остеокоррекции', shortTitle: 'Диссекция' },
    { start: '2026-12-18', end: '2026-12-20', title: 'Мастер-класс по работе с особенными детьми', target: '#calendar', program: 'Мастер-класс', shortTitle: 'Особенные дети' },
    // Биодинамика
    ...
    // Конференции
    { start: '2026-11-07', end: '2026-11-08', title: 'Конференция «Секреты Мастеров»', target: '#calendar', program: 'Конференция', shortTitle: 'Секреты Мастеров', format: 'Онлайн', audience: 'Для всех специалистов' }
];
